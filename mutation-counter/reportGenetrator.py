...
class GenerateReport:
    ...
    def write_report_xls(root):
        ...
        report_name = '/reportMutation.xlsx'

        count = countMutators.CountMutators()
        ...
        mutantMathMutator, \
        mutantMathMutatorKilled = count.parse_file(path_file)

        report_mutants = xlsxwriter.Workbook(root + report_name)
        worksheet = report_mutants.add_worksheet()
